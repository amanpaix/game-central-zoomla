...
<html lang="<?php echo $this->language; ?>" dir="<?php echo $this->direction; ?>">
	<head>
        ...
        <script>
            ...
            var DRAW_TIME =  '20:30:00.000000';
            var timerArray  = [];
            var footerTimerArray  = [];
            var gameListLimit = <?php echo Constants::GAME_LIST_LIMIT; ?>
	...
	<body loaded="true" class="<?php echo $theme->bodyClass(); ?> <?php
    if (Session::sessionValidate()) {
        echo " post-login ";
    } else {
        echo " pre-login ";
    }
    $pctype = Configuration::getDeviceType();
    if($pctype == "PC"){
        echo " responsePc ";
    }else echo " responseMobile ";
    echo "os-". Configuration::getOS(); ?>">
...
<!--				--><?php //echo $theme->getPreloader($this->params->get('loader_type', '')); ?>
    ...
    <script>
        ...
        var mytoken = '<?php echo Utilities::getPlayerToken(); ?>';
        ...
        var defaultCurrencyCode = '<?php echo Constants::DEFAULT_CURRENCY_CODE; ?>';
        var defaultCurrencyDisp = '<?php echo Constants::$currencyMap[Constants::DEFAULT_CURRENCY_CODE]['entity']; ?>';
        <?php
        if( Session::sessionValidate() ){
        ?>
        defaultCurrencyCode = '<?php echo Utilities::getPlayerLoginResponse()->walletBean->currency;  ?>';
        defaultCurrencyDisp = '<?php echo Utilities::getPlayerLoginResponse()->walletBean->currencyDisplayCode;  ?>';
        <?php
        }
        ?>
    </script>
