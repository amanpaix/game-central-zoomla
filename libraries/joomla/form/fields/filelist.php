...
class JFormFieldFileList extends JFormFieldList
{
    ...
    public function setup(SimpleXMLElement $element, $value, $group = null)
    {
        ...
        if ($return)
        {
            ...
            $this->recursive = ($recursive == 'true' || $recursive == 'stripExt' || $recursive == '1');

            $fullpath       = (string) $this->element['fullpath'];
            $this->fullpath = ($fullpath == 'true' || $fullpath == 'stripExt' || $fullpath == '1');
