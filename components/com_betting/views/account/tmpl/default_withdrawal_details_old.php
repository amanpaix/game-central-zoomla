    ...
    <div class="transaction_details">
        <div class="transction_filter">
            <form id="withdrawal-details-form">
                ...
                <div class="filter">
                    <a class="brown_bg btn_search" id="search" href="javascript:;"><?php echo JText::_("SEARCH");?></a>
                    <div class="clear"></div>
                </div>
            </form>
        </div>
       	...
       	<div id="error-div" class="alert_msg_div" style="display: none;">
            <div class="alert alert-danger"><a class="close" data-dismiss="alert">×</a><div><p class="error-div-txt"><?php echo JText::_("WITHDRAWL_NO_DETAIL");?>.</p></div></div>
        </div>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text">
                    <div class="success_title"><img src="<?php echo Redirection::BASE; ?>/templates/shaper_helix3/images/my_account/insufficient_icon.png"> <span><?php echo JText::_("WITHDRAWL_CANCEL");?></span></div>
                    <p><?php echo JText::_("WITHDRAWL_CANCEL_MESSAGE");?></p>
                    <div class="form-group">
                        <button type="button" data-dismiss="modal" id="doWithdrawal" class="green_bg"><?php echo JText::_("YES_BUTTON")?></button><button type="button" class="black_bg" data-dismiss="modal" aria-label="Close"><?php echo JText::_("NO_BUTTON")?></button>
                    </div>
                </div>
                <div class="clear"></div>
            </div>
...
<div class="modal fade withdraw_status_popup" id="Withdrawal_success">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text">
                    <h4 class="success_title"><?php echo JText::_("SUCCESS");?></h4>
                    <p><?php echo JText::_("SUCCESS_WITHDRWAL_CANCEL_MSG");?></p>
                </div>
                <div class="clear"></div>
            </div>
        </div><!-- /.modal-content -->
...
<script>
    ...
    functior processWithdrawalDetails(result)
    {
