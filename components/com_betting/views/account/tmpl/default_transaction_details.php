...
Html::addJs(JUri::base() . "/templates/shaper_helixultimate/js/revolution.extension.slideanims.min.js");
Html::addJs(JUri::base() . "/templates/shaper_helixultimate/js/revolution.extension.navigation.min.js");
Html::addJs(JUri::base() . "/templates/shaper_helixultimate/js/bootstrap-datepicker.lang.js");
...
//            $('#bonus-chips').text(res.bonusList[0].amount);
        ...
        for(var i = 0; i < totRows; i++) {
            ...
            if(typeof res.bonusList[i].contribution != 'undefined')
                wrRequirement = '<?php echo $dispCurrency ;?>'+res.bonusList[i].contribution;
            ...
            var newRow = '<tr>' +
                '<td>'+receivedDate+'</td>' +
                '<td>'+bonusCode+'</td>' +
                '<td><?php echo $dispCurrency;?>'+amount+'</td>' +
                '<td><?php echo $dispCurrency;?>'+target+'</td>' +
                '<td>'+wrRequirement+'</td>' +
                '<td><?php echo $dispCurrency;?>'+redeemedAmount+'</td>' +
                '<td>'+bonusCriteria+'</td>' +
                '<td>'+expiredDate+'</td>' +
                '<td>'+status+'</td>' +
                '</tr>';
