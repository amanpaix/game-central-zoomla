...
require_once JPATH_BETTING_COMPONENT.'/controller.php';
...
class ContentController extends JControllerLegacy
{
	...
	public function __construct($config = array())
	{
        ...
        $BETTING_controller = new BettingController();
        $BETTING_controller->specialCheck(JFactory::getApplication()->getMenu()->getActive()->route);
