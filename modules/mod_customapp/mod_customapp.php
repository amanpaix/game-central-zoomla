...
if ($params->def('prepare_content', 1)) {
    ...
    $module->content = JHtml::_('content.prepare', $module->content, '', 'mod_customapp.content');
}
...
require JModuleHelper::getLayoutPath('mod_customapp', $params->get('layout', 'default'));
